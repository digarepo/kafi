...
function SidebarProvider({
  ...
  React.useEffect(() => {
    ...
    if (stored === "false") _setOpen(false);
  }, [openProp]);
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:inset-s-1/2 after:w-0.5 hover:after:bg-sidebar-border lg:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
