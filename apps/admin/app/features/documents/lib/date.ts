/**
 * Date helpers for the documents and visa application admin forms.
 *
 * @remarks
 * - These helpers are kept minimal because the forms use the shared `DatePicker`.
 * - All conversions use the local time noon trick internally where dates are required.
 */
