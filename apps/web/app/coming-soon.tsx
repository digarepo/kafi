  ...
  if (status === 'progress') {
    return (
      <div className="w-5 h-5 rounded-full bg-brand-gold/10 dark:bg-brand-gold/20 flex items-center justify-center">
        <Loader className="w-3 h-3 text-brand-gold animate-spin" />
      </div>
    );
  }
  ...
  return (
    <div className="relative w-48 h-48 md:w-56 md:h-56 mx-auto mb-8 animate-fade-in">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-22 h-22 md:w-24 md:h-24 rounded-full bg-linear-to-br from-brand-primary to-brand-light dark:from-brand-primary dark:to-brand-dark flex items-center justify-center shadow-elevated transform  hover:rotate-360 transition-transform duration-900">
          <img src="/kafi-icon-gold.svg" className="w-16 h-16 object-contain" />
        </div>
      </div>
    ...
    <div className="min-h-screen bg-background relative flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-xl mx-auto px-6 py-12">
        ...
        >
          ...
          >
            We're working behind the scenes to create an exceptional experience.
